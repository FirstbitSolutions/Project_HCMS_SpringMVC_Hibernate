...
public class ApplicationStatusDAOImpl implements ApplicationStatusDAO {
	...
	public List<ApplicationStatus> getAll() {
		...
		try {
			...
			list = session.createQuery("FROM ApplicationStatus", ApplicationStatus.class).getResultList();
			System.out.println("Retriev List of Objects : ");
			for (ApplicationStatus obj : list) {
	...
	public ApplicationStatus getApplicationStatusById(Long id) {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Transaction Started .......");
			obj = session.get(ApplicationStatus.class, Integer.valueOf(id.intValue()));
	...
	public ApplicationStatus update(ApplicationStatus obj) {
		System.out.println("------------   START --------------");
		Transaction tx = null;
		ApplicationStatus updatedObj = null;
		Session session = null;
		try {
			session = sessionFactory.openSession();
			System.out.println("Session Created .......");
			tx = session.beginTransaction();
			System.out.println("Transaction Started .......");
			updatedObj = (ApplicationStatus) session.merge(obj);
	...
	public void delete(Long id) {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Transaction Started .......");
			ApplicationStatus obj = session.get(ApplicationStatus.class, Integer.valueOf(id.intValue()));
			if (obj != null) {
				session.remove(obj);
