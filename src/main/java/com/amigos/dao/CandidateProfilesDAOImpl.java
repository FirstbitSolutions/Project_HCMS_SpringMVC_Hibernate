...
public class CandidateProfilesDAOImpl implements CandidateProfilesDAO {
	...
	public List<CandidateProfiles> getAll() {
		...
		Transaction tx = null;
		List<CandidateProfiles> list = new ArrayList<>();
		...
		try {
			...
			list = session.createQuery("FROM CandidateProfiles", CandidateProfiles.class).getResultList();
			System.out.println("Retriev List of Objects : ");
			for (CandidateProfiles obj : list) {
	...
	public CandidateProfiles getCandidateProfilesById(Long id) {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Transaction Started .......");
			obj = session.get(CandidateProfiles.class, Integer.valueOf(id.intValue()));
	...
	public CandidateProfiles update(CandidateProfiles obj) {
		System.out.println("------------   START --------------");
		Transaction tx = null;
		CandidateProfiles updatedObj = null;
		Session session = null;
		try {
			session = sessionFactory.openSession();
			System.out.println("Session Created .......");
			tx = session.beginTransaction();
			System.out.println("Transaction Started .......");
			updatedObj = (CandidateProfiles) session.merge(obj);
	...
	public void delete(Long id) {
		...
		try {
			...
			tx = session.beginTransaction();
			System.out.println("Transaction Started .......");
			CandidateProfiles obj = session.get(CandidateProfiles.class, Integer.valueOf(id.intValue()));
			if (obj != null) {
				session.remove(obj);
